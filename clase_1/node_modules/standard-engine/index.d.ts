export const cli: typeof import("standard-engine/bin/cmd");
export type EslintOptions = import('eslint').ESLint.Options;
export type BaseLintOptions = Omit<import('standard-engine/lib/resolve-eslint-config').ResolveOptions, 'cmd' | 'cwd'>;
export type StandardEngineOptions = {
    cmd: string;
    eslint: typeof import("eslint");
    cwd?: string | undefined;
    eslintConfig?: import("eslint").ESLint.Options | undefined;
    resolveEslintConfig?: import("standard-engine/lib/resolve-eslint-config").CustomEslintConfigResolver | undefined;
...
export class StandardEngine {
    ...
    /** @type {string} */
    cwd: string;
    customEslintConfigResolver: import("standard-engine/lib/resolve-eslint-config").CustomEslintConfigResolver | undefined;
    /** @type {EslintOptions} */
