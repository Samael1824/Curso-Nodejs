 ...
 * @returns {void}
 */
declare function cli(rawOpts: Omit<import('standard-engine').StandardEngineOptions, 'cmd'> & StandardCliOptions): void;
declare namespace cli {
    export { StandardCliOptions };
}
type StandardCliOptions = {
    standardEngine?: import("standard-engine").StandardEngine | undefined;
